    ...
    <div className="border-l-2 border-[#4b5563] pl-4 ml-4 mt-2">
      ...
      <div className="flex gap-3 items-center pt-2">
        <textarea
          ...
          className="flex-1 p-2 border border-transparent rounded-xl bg-black/30 backdrop-blur-2xl focus:bg-white/80 focus:text-black placeholder-light-4 focus:outline-none focus:border-transparent resize-none transition duration-300 focus:shadow-theme-top"
          style={{
            height: "30px",
            overflow: "hidden",
            lineHeight: "30px",
